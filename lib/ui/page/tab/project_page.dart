...
import 'package:flutter_demo/flutter/dropdown.dart';
...
import 'package:flutter_demo/view_model/project_model.dart';
      ...
      child: Theme(
        ...
        child: DropdownButtonHideUnderline(
          ...
          onChanged: (value) {
            ...
            DefaultTabController.of(context)?.animateTo(200);
          },
          isExpanded: true,
          icon: Container(
            child: Icon(
